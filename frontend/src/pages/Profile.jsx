  ...
  return (
    <div className='w-full min-h-screen bg-black'>
        ...
        items-center px-[30px] text-white'>
            <div onClick={()=>navigate("/")}><MdKeyboardBackspace 
            className='text-white w-[25px] h-[25px] cursor-pointer'/></div>
            <div className='font-semibold text-[20px]'>{profileData?.userName}</div>
            <div className='font-semibold cursor-pointer text-[20px]
            text-blue-500' onClick={handleLogOut}>Log Out</div>
        </div>
        {/* user details */}
        ...
        md:gap-[60px] px-[20%] pt-[30px] text-white'>
            <div>
                <div className='text-white text-[22px] md:text-[30px]
                font-semibold'>{profileData?.posts.length}</div>
        ...
        <div className='w-full h-[80px] flex justify-center items-center
         gap-[20px] mt-[10px]'>
            ...
            <FollowButton tailwind={`px-[10px] min-w-[150px] py-[5px] h-[40px] bg-white
            cursor-pointer rounded-2xl`} targetUserId={profileData?._id} onFollowChange={handleProfile}/>
            <button className='px-[10px] min-w-[150px] py-[5px] h-[40px] bg-white
        ...
        <div className='w-full min-h-[100vh] flex justify-center'>
            ...
            bg-white relative gap-[20px] pt-[30px] pb-[100px]'>
                ...
                {profileData?._id == userData._id &&
                    <div className='w-[90%] max-w-[500px] h-[80px] bg-white rounded-full
